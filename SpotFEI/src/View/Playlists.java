...
public class Playlists extends javax.swing.JFrame {
    private PlaylistController control_1;
    
    private JList<String> lista_playlist;
    public JList<String> getLista() {
        return lista_playlist;
    } 
    
    private DefaultListModel<String> modelo_playlist;
    
    public Playlists() {
        initComponents();
        control_1 = new PlaylistController(this);
        
        modelo_playlist = new DefaultListModel<>();
        this.lista_playlist = jList1;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // PLAYLISTS
        control_1.buscarPlaylists();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // MUSICAS
        control_1.buscarTodos();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // PESQUISA
        control_1.buscarPesquisa();
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // +
        control_1.criarPlaylist();
    ...
    public JButton getBotao_Playlist(){
        return jButton1;
    }
    public JButton getBotao_Musica(){
        return jButton2;
    }
